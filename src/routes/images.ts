...
router.get("/:bucketType/:imageType/:num/:num2/:imageId.:ext", async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const raw = await sharp(originalBuffer).ensureAlpha().raw().toBuffer();
